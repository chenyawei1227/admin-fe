                                    ...
                                    this.state.list.length ? this.state.list.map((product, index) => {
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td width="20%">
                                                    <Link className="opear btn btn-xl btn-primary" to={ '/product/detail/' + product.id}>查看</Link>
                                                    <Link className="opear btn btn-xl btn-primary"  to={ '/product/save/' + product.id}>编辑</Link>
                                                </td>
                                            </tr>
                                        );
                                    }) :
